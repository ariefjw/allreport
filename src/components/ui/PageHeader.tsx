...
export function PageHeader({ title, description, date, actions, mobileActions, glow }: PageHeaderProps) {
  return (
    <>
      ...
      {mobileActions && (
        <div className="fixed bottom-[calc(3.5rem+env(safe-area-inset-bottom))] left-0 right-0 z-40 border-t border-hairline bg-canvas/90 backdrop-blur-lg md:hidden">
